...
**Arc Raiders Steam Build: 23681279 (2026-06-16)**
...
New snapshot tags use `arc-<steam-build-id>-exfil-<exfil-version>`. The current snapshot tag is `arc-23681279-exfil-v0.13.1`.
...
| Metric | Count |
| --- | ---: |
| Unique asset IDs | 4,349 |
| Internal asset names | 4,312 |
| English display names | 3,518 |
| English descriptions | 794 |
| Localization rows | 36,457 |
| Localized display names (de) | 2,672 |
| Localized display names (es) | 2,609 |
| Localized display names (fr) | 2,702 |
| Localized display names (it) | 2,711 |
| Localized display names (ja) | 2,798 |
| Localized display names (ko) | 2,799 |
| Localized display names (pl) | 2,735 |
| Localized display names (pt_br) | 2,750 |
| Localized display names (ru) | 2,799 |
| Localized display names (tr) | 2,757 |
| Localized display names (zh_hans) | 2,799 |
| Localized display names (zh_hant) | 2,799 |
| PNG icons | 1,188 |
...
For production use, pin to a snapshot tag such as `arc-23681279-exfil-v0.13.1` instead of tracking `main`. The dataset is still pre-1.0.0, so schema details may change; update deliberately after checking `schema.json` and this README.

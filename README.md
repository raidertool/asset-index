...
**Arc Raiders Steam Build: 24710327 (2026-08-18)**
...
New snapshot tags use `arc-<steam-build-id>-exfil-<exfil-version>`. The current snapshot tag is `arc-24710327-exfil-v0.13.4`.
...
| Metric | Count |
| --- | ---: |
| Unique asset IDs | 4,658 |
| Internal asset names | 4,621 |
| English display names | 3,753 |
| English descriptions | 794 |
| Localization rows | 39,463 |
| Localized display names (de) | 2,894 |
| Localized display names (es) | 2,831 |
| Localized display names (fr) | 2,931 |
| Localized display names (it) | 2,941 |
| Localized display names (ja) | 3,033 |
| Localized display names (ko) | 3,034 |
| Localized display names (pl) | 2,968 |
| Localized display names (pt_br) | 2,980 |
| Localized display names (ru) | 3,034 |
| Localized display names (tr) | 2,987 |
| Localized display names (zh_hans) | 3,034 |
| Localized display names (zh_hant) | 3,034 |
| PNG icons | 1,227 |
...
For production use, pin to a snapshot tag such as `arc-24710327-exfil-v0.13.4` instead of tracking `main`. The dataset is still pre-1.0.0, so schema details may change; update deliberately after checking `schema.json` and this README.

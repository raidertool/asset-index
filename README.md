...
**Arc Raiders Steam Build: 24017548 (2026-07-07)**
...
New snapshot tags use `arc-<steam-build-id>-exfil-<exfil-version>`. The current snapshot tag is `arc-24017548-exfil-v0.13.2`.
...
| Metric | Count |
| --- | ---: |
| Unique asset IDs | 4,573 |
| Internal asset names | 4,536 |
| English display names | 3,701 |
| English descriptions | 794 |
| Localization rows | 38,795 |
| Localized display names (de) | 2,844 |
| Localized display names (es) | 2,781 |
| Localized display names (fr) | 2,880 |
| Localized display names (it) | 2,890 |
| Localized display names (ja) | 2,981 |
| Localized display names (ko) | 2,982 |
| Localized display names (pl) | 2,916 |
| Localized display names (pt_br) | 2,929 |
| Localized display names (ru) | 2,982 |
| Localized display names (tr) | 2,936 |
| Localized display names (zh_hans) | 2,982 |
| Localized display names (zh_hant) | 2,982 |
| PNG icons | 1,210 |
...
For production use, pin to a snapshot tag such as `arc-24017548-exfil-v0.13.2` instead of tracking `main`. The dataset is still pre-1.0.0, so schema details may change; update deliberately after checking `schema.json` and this README.

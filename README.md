...
**Arc Raiders Steam Build: 24350345 (2026-07-28)**
...
New snapshot tags use `arc-<steam-build-id>-exfil-<exfil-version>`. The current snapshot tag is `arc-24350345-exfil-v0.13.4`.
...
| Metric | Count |
| --- | ---: |
| Unique asset IDs | 4,574 |
| Internal asset names | 4,537 |
| English display names | 3,704 |
| English descriptions | 794 |
| Localization rows | 38,834 |
| Localized display names (de) | 2,847 |
| Localized display names (es) | 2,784 |
| Localized display names (fr) | 2,883 |
| Localized display names (it) | 2,893 |
| Localized display names (ja) | 2,984 |
| Localized display names (ko) | 2,985 |
| Localized display names (pl) | 2,919 |
| Localized display names (pt_br) | 2,932 |
| Localized display names (ru) | 2,985 |
| Localized display names (tr) | 2,939 |
| Localized display names (zh_hans) | 2,985 |
| Localized display names (zh_hant) | 2,985 |
| PNG icons | 1,211 |
...
For production use, pin to a snapshot tag such as `arc-24350345-exfil-v0.13.4` instead of tracking `main`. The dataset is still pre-1.0.0, so schema details may change; update deliberately after checking `schema.json` and this README.
